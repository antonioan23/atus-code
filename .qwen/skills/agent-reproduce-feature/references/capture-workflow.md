...
- Target program: atus code in the current working directory unless the user explicitly provides another path.
...
```sh
.atus-code/skills/agent-reproduce-feature/scripts/run_with_mitm.sh OUT_DIR -- COMMAND ARG...
```
...
```sh
.atus-code/skills/agent-reproduce-feature/scripts/run_tmux_capture.sh OUT_DIR COMMAND ARG...
```
