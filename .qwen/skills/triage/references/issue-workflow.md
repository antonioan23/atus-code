...
- **Inadmissible**: religious or political flame wars, harassment, abusive
  language, spam, or content unrelated to atus code.
...
1. Run `/goal Is this feature request truly aligned with atus code's product direction, and is the proposed approach the best solution?`
