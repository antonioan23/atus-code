...
A short atus-code case to illustrate two failure modes from `SKILL.md`:
...
`~/.atus-code/logs` shows the model returned proper text. Stdout was empty.
...
Fix commit: atus-code `feadf052f` — `fix(cli): append newline to text-mode
