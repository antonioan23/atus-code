---
name: feat-dev
description: End-to-end workflow for implementing a non-trivial atus-code
...
Use this workflow when implementing a feature in atus-code that needs design,
...
Use `.atus-code/` paths for planning artifacts:

- `.atus-code/design/<feature>.md`
- `.atus-code/e2e-tests/<feature>.md`

## Phase 1: Investigate

Understand the requested behavior and the current atus-code implementation.
