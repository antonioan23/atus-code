...
```bash
cd /Users/gawain/Documents/codebase/opensource/atus-code-table-wrap-ansi-highlight
...
ATUS_TUI_E2E_OUT=/tmp/atus-table-wrap-ansi/fixed \
  npx tsx integration-tests/terminal-capture/table-inline-code-wrap-regression.ts

ATUS_TUI_E2E_REPO=/Users/gawain/Documents/codebase/opensource/atus-code-table-wrap-ansi-highlight-base \
ATUS_TUI_E2E_OUT=/tmp/atus-table-wrap-ansi/base \
ATUS_TUI_E2E_EXPECT_PASS=false \
  npx tsx integration-tests/terminal-capture/table-inline-code-wrap-regression.ts
```
...
- Base summary: `/tmp/atus-table-wrap-ansi/base/summary.json`
- Base raw ANSI: `/tmp/atus-table-wrap-ansi/base/raw.ansi.log`
- Base screenshot: `/tmp/atus-table-wrap-ansi/base/table-inline-code-wrap.png`
- Fixed summary: `/tmp/atus-table-wrap-ansi/fixed/summary.json`
- Fixed raw ANSI: `/tmp/atus-table-wrap-ansi/fixed/raw.ansi.log`
- Fixed screenshot: `/tmp/atus-table-wrap-ansi/fixed/table-inline-code-wrap.png`
