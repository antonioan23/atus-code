 ...
 *
 * Tests the actual MockPluginChannel (from @atus-code/channel-plugin-example) connected
 ...
 *           → atus-code --acp (REAL model request)
...
describe('Channel Plugin (Mock WebSocket E2E)', () => {
  ...
  const setup = async () => {
    ...
    // 2. Start AcpBridge (spawns real atus-code --acp)
