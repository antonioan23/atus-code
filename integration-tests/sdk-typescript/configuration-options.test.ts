...
describe('Configuration Options (E2E)', () => {
  ...
  describe('authType Option', () => {
    ...
    // Skip - atus-oauth requires user interaction which is not possible in CI environments
    it.skip('should accept authType: atus-oauth', async () => {
      // Note: atus-oauth requires credentials in ~/.atus-code and user interaction
