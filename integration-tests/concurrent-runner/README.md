...
```json
{
  ...
  "yolo": true,
  "source_repo": ".",
  "worktree_base": "~/.atus-code/worktrees",
  "outputs_dir": "./outputs",
...
| `worktree_base` | string | ~/.atus-code/worktrees | Base directory for git worktrees              |
  ...
  "runs": [
    {
      ...
      "status": "succeeded",
      "worktree_path": "~/.atus-code/worktrees/run-abc123",
...
4. **Execute**: Run atus CLI with captured output (logs go to run-specific folder)
