...
This document describes the `exit_plan_mode` tool for atus code.
...
## How to use `exit_plan_mode` with atus code

The Exit Plan Mode tool is part of atus code's planning workflow. When you're in plan mode (typically after exploring a codebase and designing an implementation approach), you use this tool to:
