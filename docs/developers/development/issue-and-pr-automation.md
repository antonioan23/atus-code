...
- **Workflow File**: `.github/workflows/atus-automated-issue-triage.yml`
...
- **Workflow File**: `.github/workflows/atus-scheduled-pr-triage.yml`
...
- **Workflow File**: `.github/workflows/atus-scheduled-issue-triage.yml`
- **When it runs**: Every hour on all open issues.
- **What it does**:
  - It actively seeks out issues that either have no labels at all or still have the `status/need-triage` label.
  - It then triggers the same powerful AtusCode-based analysis as the initial triage bot to apply the correct labels.
- **What you should do**:
...
This workflow handles the process of packaging and publishing new versions of atus code.
