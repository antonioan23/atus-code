...
<dependency>
    ...
    <artifactId>atuscode-sdk</artifactId>
...
```gradle
implementation 'com.alibaba:atuscode-sdk:{$version}'
```
...
The simplest way to use the SDK is through the `AtusCodeCli.simpleQuery()` method:
...
public static void runTransportOptionsExample() {
    ...
    List<String> result = AtusCodeCli.simpleQuery("who are you, what are your capabilities?", options);
    result.forEach(logger::info);
}
```
...
public static void runStreamingExample() {
    AtusCodeCli.simpleQuery("who are you, what are your capabilities?",
...
other examples see src/test/java/com/alibaba/atus/code/cli/example
