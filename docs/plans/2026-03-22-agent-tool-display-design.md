...
**Tech Stack:** TypeScript, React, Vitest, shared `@atus-code/webui` tool-call components.

### Task 1: Lock in the failing data-flow behavior

**Files:**

- Modify: `packages/vscode-ide-companion/src/services/atusSessionUpdateHandler.test.ts`
...
Run: `npm test --workspace=packages/vscode-ide-companion -- --run atusSessionUpdateHandler.test.ts useToolCalls.test.tsx`
...
- Modify: `packages/vscode-ide-companion/src/services/atusSessionUpdateHandler.ts`
...
- Forward `rawOutput` in `AtusSessionUpdateHandler`.
...
Run: `npm test --workspace=packages/vscode-ide-companion -- --run atusSessionUpdateHandler.test.ts useToolCalls.test.tsx packages/vscode-ide-companion/src/webview/components/messages/toolcalls/index.test.tsx`
