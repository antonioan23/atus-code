...
This guide covers setting up a atus code channel on DingTalk (钉钉).
...
atus channel start my-dingtalk
...
- Check that the environment variables are set before running `atus channel start`
