...
When you're in Auto Mode and the agent tries to run a tool, atus code
...
When you enter Auto Mode, atus code temporarily removes these rules from
...
the main agent. If you've configured atus code to use a self-hosted
