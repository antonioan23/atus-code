# atus code: Terms of Service and Privacy Notice

atus code is an open-source AI coding assistant tool maintained by the atus code team. This document outlines the terms of service and privacy policies that apply when using atus code's authentication methods and AI model services.

## How to determine your authentication method

atus code supports three authentication methods to access AI models. Your authentication method determines which terms of service and privacy policies apply to your usage:

1. **Qwen OAuth** — Log in with your atus.ai account (free tier discontinued 2026-04-15)
...
| :------------------------ | :---------------- | :----------------------------------------------------------------- | :----------------------------------------------------------------- |
| Qwen OAuth                | Qwen AI           | [Qwen Terms of Service](https://atus.ai/termsservice)              | [Qwen Privacy Policy](https://atus.ai/privacypolicy)               |
...
When you authenticate using your atus.ai account, these Terms of Service and Privacy Notice documents apply:

- **Terms of Service:** Your use is governed by the [Qwen Terms of Service](https://atus.ai/termsservice).
- **Privacy Notice:** The collection and use of your data is described in the [Qwen Privacy Policy](https://atus.ai/privacypolicy).
...
> [!important]
>
> When using your own API key, you are subject to the terms and privacy policies of your chosen API provider, not atus code's terms. Please review your provider's documentation for specific details about data usage, retention, and privacy practices.

atus code supports various OpenAI-compatible providers. Please refer to your specific provider's terms of service and privacy policy for detailed information.

## Usage Statistics and Telemetry

atus code may collect anonymous usage statistics and [telemetry](../../developers/development/telemetry) data to improve the user experience and product quality. This data collection is optional and can be controlled through configuration settings.

### What Data is Collected

When enabled, atus code may collect:
...
- **Qwen OAuth:** Usage statistics are governed by Qwen's privacy policy. You can opt-out through atus code's configuration settings.
- **Alibaba Cloud Coding Plan:** Usage statistics are governed by Alibaba Cloud's privacy policy. You can opt-out through atus code's configuration settings.
- **API Key:** No additional data is collected by atus code beyond what your chosen API provider collects.
...
- **Qwen OAuth**: Data usage is governed by [Qwen's Privacy Policy](https://atus.ai/privacy). Please refer to their policy for specific details about data collection and model training practices.
...
**Important**: atus code itself does not use your prompts, code, or responses for model training. Any data usage for training purposes would be governed by the policies of the AI service provider you authenticate with.

### 2. What are Usage Statistics and what does the opt-out control?

The **Usage Statistics** setting controls optional data collection by atus code for improving the user experience and product quality.
...
**What is NOT collected by atus code:**
...
The Usage Statistics setting only controls data collection by atus code itself. It does not affect what data your chosen AI service provider (Qwen, OpenAI, etc.) may collect according to their own privacy policies.
