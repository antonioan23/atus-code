...
// IMPORTANT: __atus_filename / __atus_dirname always resolve to this shim's
...
export const __atus_filename = fileURLToPath(import.meta.url);
export const __atus_dirname = dirname(__atus_filename);
