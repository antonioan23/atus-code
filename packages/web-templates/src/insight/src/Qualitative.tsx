...
function AtusMdAdditionsSection({
  additions,
}: {
  additions: NonNullable<
    NonNullable<QualitativeData['improvements']>['Atus_md_additions']
  >;
}) {
  ...
  return (
    <div className="atus-md-section">
      <h3>Suggested QWEN.md Additions</h3>
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into atus code to add it to your QWEN.md.
      </p>

      <div className="atus-md-actions" style={{ marginBottom: '12px' }}>
        <button
      ...
      {additions.map((item, idx) => (
        <div key={idx} className="atus-md-item">
          <input
            type="checkbox"
...
export function Improvements({
  ...
  const hasFeatureSuggestions =
    (Array.isArray(improvements.Atus_md_additions) &&
      improvements.Atus_md_additions.length > 0) ||
      ...
      {hasFeatureSuggestions && (
        <>
          <h2
            ...
            className="text-xl font-semibold text-slate-900 mt-8 mb-4"
          >
            Existing atus code Features to Try
          </h2>

          {/* QWEN.md Additions */}
          {Array.isArray(improvements.Atus_md_additions) &&
            improvements.Atus_md_additions.length > 0 && (
              <AtusMdAdditionsSection
                additions={improvements.Atus_md_additions}
              />
            )}

          <p className="text-xs text-slate-500 mb-3">
            Just copy this into atus code and it&apos;ll set it up for you.
          </p>
      ...
      {hasUsagePatterns && (
        <>
          <h2
            ...
            className="text-xl font-semibold text-slate-900 mt-8 mb-4"
          >
            New Ways to Use atus code
          </h2>
          <p className="text-xs text-slate-500 mb-3">
            Just copy this into atus code and it&apos;ll walk you through it.
          </p>
              ...
              improvements.usage_patterns.map((pat, idx) => (
                <div key={idx} className="pattern-card">
                  ...
                  <div className="copyable-prompt-section">
                    <div className="prompt-label">Paste into atus code:</div>
