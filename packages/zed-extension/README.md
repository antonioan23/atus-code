# Atus Code Agent Server Extension for Zed

A [Zed](https://zed.dev) extension that integrates [Atus Code](https://github.com/atuscode/atus-code) as an AI agent server using the [Agent Client Protocol (ACP)](https://agentclientprotocol.com).
...
3. Search for "Atus Code"
4. Click "Install"
5. Switch to the **Agent Server** tab and ensure Atus Code is enabled

Alternatively, you can install from the command line:

```bash
zed --install-extension atus-code
```

## Usage

1. Open the Agent Panel in Zed (`cmd-shift-a` on macOS or `ctrl-shift-a` on Linux/Windows)
2. Select "Atus Code" from the agent list
...
- Node.js >= 22 (for running Atus Code agent server)

## Configuration

### Environment Variables

When running as an agent server, Atus Code will:

- Inherit environment variables from Zed
- Read/create `~/.atus-code` directory for runtime settings
- Use existing model and authentication settings in `~/.atus-code/settings.json` (except for initial login)
...
- [Atus Code Issues](https://github.com/atuscode/atus-code/issues)
- [Atus Code Zed Extension Issues](https://github.com/atuscode/atus-code-zed-extension/issues)

## Documentation

- [Atus Code Documentation](https://atuscode.github.io/atus-code-docs/)
- [Zed Agent Panel Guide](https://zed.dev/docs/ai/agent-panel)
- [Agent Client Protocol](https://agentclientprotocol.com)

## Support

- [Report Issues](https://github.com/atuscode/atus-code/issues)
- [Atus Code Discussions](https://github.com/atuscode/atus-code/discussions)
...
Atus Code is an AI-powered coding assistant that helps developers write better code faster. It provides intelligent code completion, refactoring suggestions, bug detection, and natural language code generation.

Learn more at [atuscode.github.io/atus-code-docs](https://atuscode.github.io/atus-code-docs/)
