...
//   - Remove the temporary worktree at .atus-code/tmp/review-pr-<n>.
//   - Delete the local branch ref atus-review/pr-<n>.
//   - Remove any .atus-code/tmp/atus-review-<target>-* side files.
//
...
function runCleanup(target: string): void {
  ...
  // --- Per-target side files (under .atus-code/tmp/) -------------------------
