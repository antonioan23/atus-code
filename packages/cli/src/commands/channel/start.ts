...
import { normalizeProxyUrl, Storage } from '@atus-code/atus-code-core';
import { loadSettings } from '../../config/settings.js';
import { writeStderrLine, writeStdoutLine } from '../../utils/stdioHelpers.js';
import { AcpBridge, SessionRouter } from '@atus-code/channel-base';
import type {
  ChannelBase,
  ChannelPlugin,
  ToolCallEvent,
 ...
 * Extensions declare channels in their atus-extension.json manifest.
 */
...
function checkDuplicateInstance(): void {
  ...
  if (existing) {
    ...
    writeStderrLine('Use "atus channel stop" to stop it first.');
    process.exit(1);
  }
}
