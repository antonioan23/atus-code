...
import { ApprovalMode, OutputFormat } from '@atus-code/atus-code-core';
...
describe('gemini.tsx main function', () => {
  ...
  let originalEnvAtusCodeSimple: string | undefined;
  let initialUnhandledRejectionListeners: NodeJS.UnhandledRejectionListener[] =
    [];

  beforeEach(() => {
    // Store and clear sandbox-related env variables to ensure a consistent test environment
    originalEnvGeminiSandbox = process.env['ATUS_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    originalEnvAtusCodeSimple = process.env['ATUS_CODE_SIMPLE'];
    delete process.env['ATUS_SANDBOX'];
    delete process.env['SANDBOX'];
    delete process.env['ATUS_CODE_SIMPLE'];
  ...
  afterEach(() => {
    ...
    if (originalEnvGeminiSandbox !== undefined) {
      process.env['ATUS_SANDBOX'] = originalEnvGeminiSandbox;
    } else {
      delete process.env['ATUS_SANDBOX'];
    }
    ...
    if (originalEnvAtusCodeSimple !== undefined) {
      process.env['ATUS_CODE_SIMPLE'] = originalEnvAtusCodeSimple;
    } else {
      delete process.env['ATUS_CODE_SIMPLE'];
    }
...
describe('gemini.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['ATUS_CODE_NO_RELAUNCH'];
    process.env['ATUS_CODE_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['ATUS_CODE_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['ATUS_CODE_NO_RELAUNCH'];
    }
    vi.restoreAllMocks();
  });
