...
import type { ChatRecord, Config, GeminiChat } from '@atus-code/atus-code-core';
import { ApprovalMode, AuthType } from '@atus-code/atus-code-core';
import * as core from '@atus-code/atus-code-core';
  ...
  describe('prompt', () => {
    ...
    it('passes resolved paths to read_many_files tool', async () => {
      const tempDir = await fs.mkdtemp(
        path.join(os.tmpdir(), 'atus-acp-session-'),
      );
