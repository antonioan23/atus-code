 ...
 *
 * This file does NOT mock @atus-code/atus-code-core at the module level so
 * the real Session class and its dependencies resolve correctly.
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';
import { Session } from './Session.js';
import type { Config, GeminiChat } from '@atus-code/atus-code-core';
import { ApprovalMode, AuthType, Storage } from '@atus-code/atus-code-core';
...
describe('Session.pendingWorktreeNotice', () => {
  ...
  it('VP3: first prompt prepends pendingWorktreeNotice as a <system-reminder> block', async () => {
    ...
    const notice =
      '[Resumed] Active worktree: "feat" at /repo/.atus-code/worktrees/feat ' +
