...
import { SessionService } from '@atus-code/atus-code-core';
...
describe('AtusAgent loadSession — Phase C worktree context restore', () => {
  ...
  it('VP2: live sidecar — pendingWorktreeNotice is set to contextMessage', async () => {
    const contextMessage =
      '[Resumed] Active worktree: "my-feature" at /repo/.atus-code/worktrees/my-feature ' +
