...
import { shortenPath, tildeifyPath } from '@atus-code/atus-code-core';
...
export enum AuthDisplayType {
  ATUS_OAUTH = 'atus_oauth', // deprecated: Qwen OAuth removed in Atus Code; kept for type compat
...
function formatAuthDisplayType(
  ...
  switch (value) {
    case AuthDisplayType.ATUS_OAUTH:
      return t('Qwen OAuth');
...
interface HeaderProps {
  ...
  /**
   * Sanitized replacement for the bold ">_ atus code" title in the info
    ...
    >
      ...
      >
        {/* Title line: customBannerTitle (already sanitized) or the default
            ">_ atus code" brand. Version suffix is always appended. */}
        <Text>
