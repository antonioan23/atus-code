...
const DOCS_URL = 'https://atuscode.github.io/atus-code-docs/';
    ...
    <Box flexDirection="column">
      <Box marginBottom={1}>
        <Text color={theme.text.primary}>
          {t(
            'Atus Code understands your codebase, makes edits with your permission, and executes commands right from your terminal.',
          )}
        </Text>
      </Box>
