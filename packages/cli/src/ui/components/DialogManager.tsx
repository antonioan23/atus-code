...
export const DialogManager = ({
  ...
  if (uiState.auth.isAuthenticating) {
    ...
    if (uiState.auth.pendingAuthType === AuthType.ATUS_OAUTH) {
      return (
        <QwenOAuthProgress
          deviceAuth={uiState.auth.atusAuthState.deviceAuth || undefined}
          authStatus={uiState.auth.atusAuthState.authStatus}
          authMessage={uiState.auth.atusAuthState.authMessage}
          onTimeout={() => {
