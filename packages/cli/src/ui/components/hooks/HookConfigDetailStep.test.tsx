...
describe('HookConfigDetailStep', () => {
  const createMockHookEvent = (): HookEventDisplayInfo => ({
    ...
    shortDescription: 'Right before atus code concludes its response',
    description: '',
    exitCodes: [
  ...
  it('should render source for Extensions with path', () => {
    ...
    const hookConfig = createMockHookConfig(
      ...
      'ralph-wiggum',
      '/Users/test/.atus-code/extensions/ralph-wiggum',
    );
    ...
    expect(lastFrame()).toContain('/Users/test/.atus-code/extensions/ralph-wiggum');
  });
