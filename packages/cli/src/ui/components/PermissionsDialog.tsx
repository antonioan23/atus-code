...
import { isPathWithinRoot, parseRule } from '@atus-code/atus-code-core';
  ...
  return [
    {
      ...
      description: t('Checked in at .atus-code/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.atus-code/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Atus Code won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Atus Code will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Atus Code is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
