 ...
 *
 *   2. `ATUS_DISABLE_HYPERLINKS=1` is a hard opt-out (e.g. for users whose
...
export function supportsHyperlinks(
  ...
  if (env['ATUS_DISABLE_HYPERLINKS'] === '1') return false;
