...
import type { Config, FileSearch } from '@atus-code/atus-code-core';
import { FileSearchFactory, escapePath } from '@atus-code/atus-code-core';
  ...
  useEffect(() => {
    const initialize = async () => {
      try {
        const searcher = FileSearchFactory.create({
          ...
          useQwenignore:
            config?.getFileFilteringOptions()?.respectAtusIgnore ?? true,
          cache: true,
    ...
    const search = async () => {
      ...
      try {
        ...
        // isDirectory relies on crawler.ts in @atus-code/atus-code-core
