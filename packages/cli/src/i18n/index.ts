...
import { Storage, resolveBundleDir } from '@atus-code/atus-code-core';
import {
 ...
 * @returns The path to ~/.atus-code/locales
 */
...
export function detectSystemLanguage(): SupportedLanguage {
  const envLang = process.env['ATUS_CODE_LANG'] || process.env['LANG'];
  if (envLang) {
