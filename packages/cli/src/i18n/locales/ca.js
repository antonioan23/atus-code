...
// Traduccions en català per al CLI de atus code per Jordi Mas i Hernàndez <jmas@softcatala.org>
...
export default {
  ...
  'for help on atus code': 'per a ajuda sobre atus code',
  ...
  'List available atus code tools. Usage: /tools [desc]':
    'Llistar les eines disponibles de atus code. Ús: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.atus-code/settings.json directly to manage skills at user scope.':
    "L'espai de treball no és de confiança; els paràmetres de l'espai de treball s'ignoren a la configuració fusionada. Executa /trust primer, o edita ~/.atus-code/settings.json directament per gestionar habilitats a l'àmbit d'usuari.",
  ...
  'All available skills are disabled. Edit ~/.atus-code/settings.json or .atus-code/settings.json (skills.disabled) to re-enable.':
    'Totes les habilitats disponibles estan desactivades. Edita ~/.atus-code/settings.json o .atus-code/settings.json (skills.disabled) per tornar-les a activar.',
  ...
  Bundled: 'Integrada',
  'Available atus code CLI tools:': 'Eines del CLI de atus code disponibles:',
  ...
  'open full atus code documentation in your browser':
    'obrir la documentació completa de atus code al navegador',
  ...
  // ============================================================================
  'Project Level (.atus-code/agents/)': 'Nivell de projecte (.atus-code/agents/)',
  'User Level (~/.atus-code/agents/)': "Nivell d'usuari (~/.atus-code/agents/)",
  ...
  'Generate with atus code (Recommended)': 'Generar amb atus code (Recomanat)',
  ...
  'View and edit atus code settings':
    'Veure i editar la configuració de atus code',
  Settings: 'Configuració',
  'To see changes, atus code must be restarted. Press r to exit and apply changes now.':
    'Per veure els canvis, cal reiniciar atus code. Premeu r per sortir i aplicar els canvis ara.',
  // ============================================================================
  ...
  'Respect .atusignore': 'Respectar .atusignore',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with atus code.':
    'Esteu instal·lant una extensió des de {{originSource}}. Algunes funcions poden no funcionar perfectament amb atus code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run atus code in one of these supported IDEs: VS Code or VS Code forks.':
    "La integració de l'IDE no és compatible en el vostre entorn actual. Per usar aquesta funció, executeu atus code en un dels IDEs compatibles: VS Code o bifurcacions de VS Code.",
  ...
  // Ordres - Hooks
  // ============================================================================
  'Manage atus code hooks': 'Gestionar els hooks de atus code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask atus code.':
    'Aquest menú és de només lectura. Per afegir o modificar hooks, editeu settings.json directament o demaneu-ho a atus code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask atus code.':
    'Per tornar a activar els hooks, elimineu "disableAllHooks" de settings.json o demaneu-ho a atus code.',
  Project: 'Projecte',
  User: 'Usuari',
  Skill: 'Habilitat',
  System: 'Sistema',
  ...
  'Right before atus code concludes its response':
    'Immediatament abans que atus code conclou la seva resposta',
  ...
  'Run atus --debug to see error logs':
    "Executeu atus --debug per veure els registres d'errors",
  ...
  'Generate a project summary and save it to .atus-code/PROJECT_SUMMARY.md':
    'Generar un resum del projecte i desar-lo a .atus-code/PROJECT_SUMMARY.md',
  ...
  'Invalid ATUS_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valor de ATUS_DEFAULT_AUTH_TYPE no vàlid: "{{value}}". Els valors vàlids són: {{validValues}}',
  // ============================================================================
  // Diàlegs - Model
  // ============================================================================
  ...
  "atus code won't ask before using allowed tools.":
    "atus code no preguntarà abans d'usar les eines permeses.",
  'atus code will ask before using these tools.':
    "atus code preguntarà abans d'usar aquestes eines.",
  'atus code is not allowed to use denied tools.':
    'atus code no té permís per usar les eines denegades.',
  ...
  'Checked in at .atus-code/settings.json': 'Registrat a .atus-code/settings.json',
  'User settings': "Configuració d'usuari",
  'Saved in at ~/.atus-code/settings.json': 'Desat a ~/.atus-code/settings.json',
  ...
  'atus code can read files in the workspace, and make edits when auto-accept edits is on.':
    "atus code pot llegir fitxers a l'espai de treball i fer canvis quan l'acceptació automàtica de canvis està activada.",
  'atus code will be able to read files in this directory and make edits when auto-accept edits is on.':
    "atus code podrà llegir fitxers en aquest directori i fer canvis quan l'acceptació automàtica de canvis està activada.",
  ...
  'You can run any shell commands from atus code using ! (e.g. !ls).':
    'Podeu executar qualsevol ordre shell des de atus code usant ! (p. ex. !ls).',
  ...
  'You can resume a previous conversation by running atus --continue or atus --resume.':
    'Podeu reprendre una conversa anterior executant atus --continue o atus --resume.',
  ...
  'Add a QWEN.md file to give atus code persistent project context.':
    'Afegiu un fitxer QWEN.md per donar a atus code un context persistent del projecte.',
  ...
  '  atus auth atus-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  atus auth atus-oauth     - Autenticar-se amb Qwen OAuth (descontinuat)',
  'Or simply run:': 'O simplement executeu:',
  '  atus auth                - Interactive authentication setup\n':
    "  atus auth                - Configuració interactiva de l'autenticació\n",
  ...
  '  Run `atus auth coding-plan` to re-configure.\n':
    '  Executeu `atus auth coding-plan` per tornar a configurar.\n',
  ...
  "Set up atus code's status line UI":
    "Configurar la interfície de la barra d'estat de atus code",
