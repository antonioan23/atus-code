...
// Русский перевод для atus code CLI
...
export default {
  ...
  'for help on atus code': 'Справка по atus code',
  ...
  'List available atus code tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов atus code. Использование: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.atus-code/settings.json directly to manage skills at user scope.':
    'Рабочая область не является доверенной; настройки рабочей области игнорируются объединённой конфигурацией. Сначала выполните /trust или отредактируйте ~/.atus-code/settings.json напрямую, чтобы управлять навыками на уровне пользователя.',
  ...
  'All available skills are disabled. Edit ~/.atus-code/settings.json or .atus-code/settings.json (skills.disabled) to re-enable.':
    'Все доступные навыки отключены. Отредактируйте ~/.atus-code/settings.json или .atus-code/settings.json (skills.disabled), чтобы снова их включить.',
  ...
  Bundled: 'Встроенный',
  'Available atus code CLI tools:': 'Доступные инструменты atus code CLI:',
  ...
  'open full atus code documentation in your browser':
    'Открытие полной документации atus code в браузере',
  ...
  // ============================================================================
  'Project Level (.atus-code/agents/)': 'Уровень проекта (.atus-code/agents/)',
  'User Level (~/.atus-code/agents/)': 'Уровень пользователя (~/.atus-code/agents/)',
  ...
  'Generate with atus code (Recommended)':
    'Сгенерировать с помощью atus code (Рекомендуется)',
  ...
  // ============================================================================
  'View and edit atus code settings': 'Просмотр и изменение настроек atus code',
  Settings: 'Настройки',
  'To see changes, atus code must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить atus code. Нажмите r для выхода и применения изменений.',
  // ============================================================================
  // Метки настроек
  // ============================================================================
  'Vim Mode': 'Режим Vim',
  ...
  'Respect .atusignore': 'Учитывать .atusignore',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with atus code.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с atus code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run atus code in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите atus code в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage atus code hooks': 'Управлять хуками atus code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask atus code.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите atus code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask atus code.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите atus code.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  Skill: 'Навык',
  ...
  'Right before atus code concludes its response':
    'Непосредственно перед завершением ответа atus code',
  ...
  'Generate a project summary and save it to .atus-code/PROJECT_SUMMARY.md':
    'Сгенерировать сводку проекта и сохранить её в .atus-code/PROJECT_SUMMARY.md',
  ...
  'Invalid ATUS_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Неверное значение ATUS_DEFAULT_AUTH_TYPE: "{{value}}". Допустимые значения: {{validValues}}',
  // ============================================================================
  // Диалоги - Модель
  // ============================================================================
  ...
  "atus code won't ask before using allowed tools.":
    'atus code не будет спрашивать перед использованием разрешённых инструментов.',
  'atus code will ask before using these tools.':
    'atus code спросит перед использованием этих инструментов.',
  'atus code is not allowed to use denied tools.':
    'atus code не может использовать запрещённые инструменты.',
  ...
  'Checked in at .atus-code/settings.json': 'Зафиксировано в .atus-code/settings.json',
  'User settings': 'Пользовательские настройки',
  'Saved in at ~/.atus-code/settings.json': 'Сохранено в ~/.atus-code/settings.json',
  ...
  'atus code can read files in the workspace, and make edits when auto-accept edits is on.':
    'atus code может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'atus code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'atus code сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'You can run any shell commands from atus code using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в atus code с помощью ! (например, !ls).',
  ...
  'You can resume a previous conversation by running atus --continue or atus --resume.':
    'Вы можете продолжить предыдущий разговор, запустив atus --continue или atus --resume.',
  ...
  'Add a QWEN.md file to give atus code persistent project context.':
    'Добавьте файл QWEN.md, чтобы предоставить atus code постоянный контекст проекта.',
  ...
  'Run atus --debug to see error logs':
    'Запустите atus --debug для просмотра журналов ошибок',
  ...
  '  atus auth atus-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  atus auth atus-oauth     - Аутентификация через Qwen OAuth (прекращено)',
  'Or simply run:': 'Или просто выполните:',
  '  atus auth                - Interactive authentication setup\n':
    '  atus auth                - Интерактивная настройка аутентификации\n',
  ...
  '  Run `atus auth coding-plan` to re-configure.\n':
    '  Выполните `atus auth coding-plan` для повторной настройки.\n',
  ...
  "Set up atus code's status line UI":
    'Настроить интерфейс строки состояния atus code',
