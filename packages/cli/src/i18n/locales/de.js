...
// German translations for atus code CLI
// Deutsche Übersetzungen für atus code CLI
...
export default {
  ...
  'for help on atus code': 'für Hilfe zu atus code',
  ...
  'List available atus code tools. Usage: /tools [desc]':
    'Verfügbare atus code Werkzeuge auflisten. Verwendung: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.atus-code/settings.json directly to manage skills at user scope.':
    'Arbeitsbereich ist nicht vertrauenswürdig; Arbeitsbereichseinstellungen werden in der zusammengeführten Konfiguration ignoriert. Führe zuerst /trust aus oder bearbeite ~/.atus-code/settings.json direkt, um Skills auf Benutzerebene zu verwalten.',
  ...
  'All available skills are disabled. Edit ~/.atus-code/settings.json or .atus-code/settings.json (skills.disabled) to re-enable.':
    'Alle verfügbaren Skills sind deaktiviert. Bearbeite ~/.atus-code/settings.json oder .atus-code/settings.json (skills.disabled), um sie wieder zu aktivieren.',
  ...
  'Available atus code CLI tools:': 'Verfügbare atus code CLI-Werkzeuge:',
  ...
  'open full atus code documentation in your browser':
    'Vollständige atus code Dokumentation im Browser öffnen',
  ...
  // ============================================================================
  'Project Level (.atus-code/agents/)': 'Projektebene (.atus-code/agents/)',
  'User Level (~/.atus-code/agents/)': 'Benutzerebene (~/.atus-code/agents/)',
  ...
  'Generate with atus code (Recommended)':
    'Mit atus code generieren (Empfohlen)',
  ...
  'View and edit atus code settings':
    'atus code Einstellungen anzeigen und bearbeiten',
  Settings: 'Einstellungen',
  'To see changes, atus code must be restarted. Press r to exit and apply changes now.':
    'Um Änderungen zu sehen, muss atus code neu gestartet werden. Drücken Sie r, um jetzt zu beenden und Änderungen anzuwenden.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim-Modus',
  ...
  'Respect .atusignore': '.atusignore beachten',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with atus code.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren möglicherweise nicht perfekt mit atus code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run atus code in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht unterstützt. Um diese Funktion zu nutzen, führen Sie atus code in einer dieser unterstützten IDEs aus: VS Code oder VS Code-Forks.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage atus code hooks': 'atus code-Hooks verwalten',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask atus code.':
    'Dieses Menü ist schreibgeschützt. Um Hooks hinzuzufügen oder zu ändern, bearbeiten Sie settings.json direkt oder fragen Sie atus code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask atus code.':
    'Um Hooks wieder zu aktivieren, entfernen Sie "disableAllHooks" aus settings.json oder fragen Sie atus code.',
  // Hooks - Source
  Project: 'Projekt',
  User: 'Benutzer',
  Skill: 'Skill',
  ...
  'Right before atus code concludes its response':
    'Direkt bevor atus code seine Antwort abschließt',
  ...
  'Generate a project summary and save it to .atus-code/PROJECT_SUMMARY.md':
    'Projektzusammenfassung generieren und in .atus-code/PROJECT_SUMMARY.md speichern',
  ...
  'Run atus --debug to see error logs':
    'Führen Sie atus --debug aus, um Fehlerprotokolle anzuzeigen',
  ...
  'Invalid ATUS_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Ungültiger ATUS_DEFAULT_AUTH_TYPE-Wert: "{{value}}". Gültige Werte sind: {{validValues}}',
  // ============================================================================
  // Dialogs - Model
  // ============================================================================
  ...
  "atus code won't ask before using allowed tools.":
    'atus code fragt nicht, bevor erlaubte Tools verwendet werden.',
  'atus code will ask before using these tools.':
    'atus code fragt, bevor diese Tools verwendet werden.',
  'atus code is not allowed to use denied tools.':
    'atus code darf verweigerte Tools nicht verwenden.',
  ...
  'Checked in at .atus-code/settings.json': 'Eingecheckt in .atus-code/settings.json',
  'User settings': 'Benutzereinstellungen',
  'Saved in at ~/.atus-code/settings.json': 'Gespeichert in ~/.atus-code/settings.json',
  ...
  'atus code can read files in the workspace, and make edits when auto-accept edits is on.':
    'atus code kann Dateien im Arbeitsbereich lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  'atus code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'atus code kann Dateien in diesem Verzeichnis lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  ...
  'You can run any shell commands from atus code using ! (e.g. !ls).':
    'Sie können beliebige Shell-Befehle in atus code mit ! ausführen (z. B. !ls).',
  ...
  'You can resume a previous conversation by running atus --continue or atus --resume.':
    'Sie können eine frühere Unterhaltung mit atus --continue oder atus --resume fortsetzen.',
  ...
  'Add a QWEN.md file to give atus code persistent project context.':
    'Fügen Sie eine QWEN.md-Datei hinzu, um atus code dauerhaften Projektkontext zu geben.',
  ...
  '  atus auth atus-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  atus auth atus-oauth     - Mit Qwen OAuth authentifizieren (eingestellt)',
  'Or simply run:': 'Oder einfach ausführen:',
  '  atus auth                - Interactive authentication setup\n':
    '  atus auth                - Interaktive Authentifizierungseinrichtung\n',
  ...
  '  Run `atus auth coding-plan` to re-configure.\n':
    '  Führen Sie `atus auth coding-plan` aus, um neu zu konfigurieren.\n',
  ...
  "Set up atus code's status line UI": 'atus codes Statusleisten-UI einrichten',
