...
// Portuguese translations for atus code CLI (pt-BR)
...
export default {
  ...
  'for help on atus code': 'para ajuda sobre o atus code',
  ...
  'List available atus code tools. Usage: /tools [desc]':
    'Listar ferramentas atus code disponíveis. Uso: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.atus-code/settings.json directly to manage skills at user scope.':
    'O espaço de trabalho não é confiável; as configurações do espaço de trabalho são ignoradas pela configuração combinada. Execute /trust primeiro, ou edite ~/.atus-code/settings.json diretamente para gerenciar habilidades no escopo do usuário.',
  ...
  'All available skills are disabled. Edit ~/.atus-code/settings.json or .atus-code/settings.json (skills.disabled) to re-enable.':
    'Todas as habilidades disponíveis estão desativadas. Edite ~/.atus-code/settings.json ou .atus-code/settings.json (skills.disabled) para reativá-las.',
  ...
  Bundled: 'Integrada',
  'Available atus code CLI tools:': 'Ferramentas CLI do atus code disponíveis:',
  ...
  'open full atus code documentation in your browser':
    'abrir documentação completa do atus code no seu navegador',
  ...
  // ============================================================================
  'Project Level (.atus-code/agents/)': 'Nível de Projeto (.atus-code/agents/)',
  'User Level (~/.atus-code/agents/)':
    'Nível de Usuário (~/.atus-code/agents/)',
  ...
  'Generate with atus code (Recommended)': 'Gerar com atus code (Recomendado)',
  ...
  // ============================================================================
  'View and edit atus code settings': 'Ver e editar configurações do atus code',
  Settings: 'Configurações',
  'To see changes, atus code must be restarted. Press r to exit and apply changes now.':
    'Para ver as alterações, o atus code deve ser reiniciado. Pressione r para sair e aplicar as alterações agora.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Modo Vim',
  ...
  'How is Atus doing this session? (optional)':
    'Como o Atus está se saindo nesta sessão? (opcional)',
  Bad: 'Ruim',
  Fine: 'Bom',
  Good: 'Ótimo',
  Dismiss: 'Ignorar',
  ...
  'Respect .atusignore': 'Respeitar .atusignore',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with atus code.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o atus code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run atus code in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o atus code em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage atus code hooks': 'Gerenciar hooks do atus code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask atus code.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao atus code.',
  ...
  'To add hooks, edit settings.json directly or ask Atus.':
    'Para adicionar hooks, edite settings.json diretamente ou pergunte ao Atus.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Atus to help.':
    'Para modificar ou remover este hook, edite settings.json diretamente ou pergunte ao Atus.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask atus code.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao atus code.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  Skill: 'Habilidade',
  ...
  'Right before atus code concludes its response':
    'Logo antes do atus code concluir sua resposta',
  ...
  'stdout shown to Atus': 'stdout mostrado ao Atus',
  ...
  // Commands - Summary
  // ============================================================================
  'Generate a project summary and save it to .atus-code/PROJECT_SUMMARY.md':
    'Gerar um resumo do projeto e salvá-lo em .atus-code/PROJECT_SUMMARY.md',
  ...
  'Run atus --debug to see error logs':
    'Execute atus --debug para ver os logs de erro',
  ...
  'Qwen OAuth has been removed in Atus Code. Use API-key auth or the OpenAI-compatible DashScope provider.':
  ...
  'Qwen OAuth (removed) - use API key': 'Autenticação Qwen OAuth',
  ...
  'Qwen OAuth (removed) - use API key Timeout':
  ...
  'Qwen OAuth has been removed': 'Aguardando autenticação Qwen OAuth...',
  ...
  'Invalid ATUS_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valor ATUS_DEFAULT_AUTH_TYPE inválido: "{{value}}". Valores válidos são: {{validValues}}',
  // ============================================================================
  // Dialogs - Model
  // ============================================================================
  ...
  "atus code won't ask before using allowed tools.":
    'O atus code não perguntará antes de usar ferramentas permitidas.',
  'atus code will ask before using these tools.':
    'O atus code perguntará antes de usar essas ferramentas.',
  'atus code is not allowed to use denied tools.':
    'O atus code não tem permissão para usar ferramentas negadas.',
  ...
  'Checked in at .atus-code/settings.json':
    'Registrado em .atus-code/settings.json',
  'User settings': 'Configurações do usuário',
  'Saved in at ~/.atus-code/settings.json':
    'Salvo em ~/.atus-code/settings.json',
  ...
  'atus code can read files in the workspace, and make edits when auto-accept edits is on.':
    'O atus code pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'atus code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O atus code poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from atus code using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do atus code usando ! (ex: !ls).',
  'Type / to open the command popup; Tab autocompletes slash commands and saved prompts.':
    'Digite / para abrir o popup de comandos; Tab autocompleta comandos de barra e prompts salvos.',
  'You can resume a previous conversation by running atus --continue or atus --resume.':
    'Você pode retomar uma conversa anterior executando atus --continue ou atus --resume.',
  ...
  'Add a QWEN.md file to give atus code persistent project context.':
    'Adicione um arquivo QWEN.md para dar ao atus code um contexto persistente do projeto.',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: Navegar | Enter: Selecionar | Esc: Cancelar',
  'Authenticate (Qwen OAuth removed; use API key)':
    'Autenticar usando Qwen OAuth',
  ...
  '  atus auth atus-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  atus auth atus-oauth     - Autenticar com Qwen OAuth (descontinuado)',
  'Or simply run:': 'Ou simplesmente execute:',
  '  atus auth                - Interactive authentication setup\n':
    '  atus auth                - Configuração interativa de autenticação\n',
  ...
  '  Run `atus auth coding-plan` to re-configure.\n':
    '  Execute `atus auth coding-plan` para reconfigurar.\n',
  ...
  "Set up atus code's status line UI":
    'Configurar a interface da barra de status do atus code',
