...
// Traductions françaises pour atus code CLI
...
export default {
  ...
  'for help on atus code': "pour l'aide de atus code",
  ...
  'List available atus code tools. Usage: /tools [desc]':
    'Lister les outils atus code disponibles. Utilisation : /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.atus-code/settings.json directly to manage skills at user scope.':
    'L’espace de travail n’est pas approuvé ; les paramètres de l’espace de travail sont ignorés par la configuration fusionnée. Exécutez d’abord /trust, ou modifiez directement ~/.atus-code/settings.json pour gérer les compétences au niveau utilisateur.',
  ...
  'All available skills are disabled. Edit ~/.atus-code/settings.json or .atus-code/settings.json (skills.disabled) to re-enable.':
    'Toutes les compétences disponibles sont désactivées. Modifiez ~/.atus-code/settings.json ou .atus-code/settings.json (skills.disabled) pour les réactiver.',
  ...
  Bundled: 'Intégrée',
  'Available atus code CLI tools:': 'Outils atus code CLI disponibles :',
  ...
  'open full atus code documentation in your browser':
    'ouvrir la documentation complète de atus code dans votre navigateur',
  ...
  // ============================================================================
  'Project Level (.atus-code/agents/)': 'Niveau projet (.atus-code/agents/)',
  'User Level (~/.atus-code/agents/)': 'Niveau utilisateur (~/.atus-code/agents/)',
  ...
  'Generate with atus code (Recommended)':
    'Générer avec atus code (Recommandé)',
  ...
  // ============================================================================
  'View and edit atus code settings':
    'Voir et modifier les paramètres de atus code',
  Settings: 'Paramètres',
  'To see changes, atus code must be restarted. Press r to exit and apply changes now.':
    'Pour voir les changements, atus code doit être redémarré. Appuyez sur r pour quitter et appliquer les changements maintenant.',
  // ============================================================================
  ...
  'Respect .atusignore': 'Respecter .atusignore',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with atus code.':
    'Vous installez une extension depuis {{originSource}}. Certaines fonctionnalités peuvent ne pas fonctionner parfaitement avec atus code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run atus code in one of these supported IDEs: VS Code or VS Code forks.':
    "L'intégration IDE n'est pas prise en charge dans votre environnement actuel. Pour utiliser cette fonctionnalité, exécutez atus code dans l'un des IDEs pris en charge : VS Code ou ses dérivés.",
  ...
  // Commandes - Hooks
  // ============================================================================
  'Manage atus code hooks': 'Gérer les hooks atus code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask atus code.':
    'Ce menu est en lecture seule. Pour ajouter ou modifier des hooks, éditez settings.json directement ou demandez à atus code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask atus code.':
    'Pour réactiver les hooks, supprimez "disableAllHooks" de settings.json ou demandez à atus code.',
  Project: 'Projet',
  User: 'Utilisateur',
  Skill: 'Compétence',
  System: 'Système',
  ...
  'Right before atus code concludes its response':
    'Juste avant que atus code conclue sa réponse',
  ...
  'Run atus --debug to see error logs':
    "Exécutez atus --debug pour voir les journaux d'erreurs",
  ...
  'Generate a project summary and save it to .atus-code/PROJECT_SUMMARY.md':
    "Générer un résumé du projet et l'enregistrer dans .atus-code/PROJECT_SUMMARY.md",
  ...
  'Invalid ATUS_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valeur ATUS_DEFAULT_AUTH_TYPE invalide : "{{value}}". Valeurs valides : {{validValues}}',
  // ============================================================================
  ...
  "atus code won't ask before using allowed tools.":
    "atus code ne demandera pas avant d'utiliser les outils autorisés.",
  'atus code will ask before using these tools.':
    "atus code demandera avant d'utiliser ces outils.",
  'atus code is not allowed to use denied tools.':
    "atus code n'est pas autorisé à utiliser les outils refusés.",
  ...
  'Checked in at .atus-code/settings.json': 'Validé dans .atus-code/settings.json',
  'User settings': 'Paramètres utilisateur',
  'Saved in at ~/.atus-code/settings.json': 'Enregistré dans ~/.atus-code/settings.json',
  ...
  'atus code can read files in the workspace, and make edits when auto-accept edits is on.':
    "atus code peut lire les fichiers dans l'espace de travail et effectuer des modifications lorsque l'acceptation automatique est activée.",
  'atus code will be able to read files in this directory and make edits when auto-accept edits is on.':
    "atus code pourra lire les fichiers dans ce répertoire et effectuer des modifications lorsque l'acceptation automatique est activée.",
  ...
  'You can run any shell commands from atus code using ! (e.g. !ls).':
    "Vous pouvez exécuter n'importe quelle commande shell depuis atus code en utilisant ! (ex. !ls).",
  ...
  'You can resume a previous conversation by running atus --continue or atus --resume.':
    'Vous pouvez reprendre une conversation précédente en exécutant atus --continue ou atus --resume.',
  ...
  '  atus auth atus-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  atus auth atus-oauth     - Authentification avec Qwen OAuth (abandonné)',
  'Or simply run:': 'Ou simplement exécutez :',
  '  atus auth                - Interactive authentication setup\n':
    "  atus auth                - Configuration d'authentification interactive\n",
  ...
  '  Run `atus auth coding-plan` to re-configure.\n':
    '  Exécutez `atus auth coding-plan` pour reconfigurer.\n',
  ...
  "Set up atus code's status line UI":
    "Configurer l'interface de la barre de statut de atus code",
  ...
  'Add a QWEN.md file to give atus code persistent project context.':
    'Ajoutez un fichier QWEN.md pour donner à atus code un contexte de projet persistant.',
