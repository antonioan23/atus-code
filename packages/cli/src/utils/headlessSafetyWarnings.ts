...
export const HEADLESS_YOLO_NO_SANDBOX_WARNING =
  ...
  'Enable a sandbox via --sandbox / ATUS_SANDBOX, or set ' +
  'ATUS_CODE_SUPPRESS_YOLO_WARNING=1 to silence this notice.';
...
export function getHeadlessYoloSafetyWarning(
  ...
  // `atus-code-sandbox`). Match the rest of the codebase
  ...
  if (isTruthyEnv(env['ATUS_CODE_SUPPRESS_YOLO_WARNING'])) return null;
