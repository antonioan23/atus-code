...
import { IdeClient } from '@atus-code/atus-code-core';
...
describe('systemInfo', () => {
  ...
  describe('getSandboxEnv', () => {
    ...
    it('should return sandbox name without prefix when stripPrefix is true', () => {
      process.env['SANDBOX'] = 'atus-code-test-sandbox';
      expect(getSandboxEnv(true)).toBe('test-sandbox');
    });

    it('should return sandbox name with prefix when stripPrefix is false', () => {
      process.env['SANDBOX'] = 'atus-code-test-sandbox';
      expect(getSandboxEnv(false)).toBe('atus-code-test-sandbox');
    });

    it('should handle atus- prefix removal', () => {
      process.env['SANDBOX'] = 'atus-custom-sandbox';
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@atus-code/atus-code-core');
