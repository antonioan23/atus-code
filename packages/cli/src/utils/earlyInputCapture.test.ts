...
describe('earlyInputCapture', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['ATUS_CODE_DISABLE_EARLY_CAPTURE'];
  });
  ...
  describe('edge cases', () => {
    ...
    it('should skip when ATUS_CODE_DISABLE_EARLY_CAPTURE is set', () => {
      process.env['ATUS_CODE_DISABLE_EARLY_CAPTURE'] = '1';
      startEarlyInputCapture();
      mockStdin.write(Buffer.from('a'));
      stopEarlyInputCapture();
