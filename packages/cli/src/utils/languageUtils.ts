 ...
 * This file handles the creation and maintenance of ~/.atus-code/output-language.md
...
const LLM_OUTPUT_LANGUAGE_MARKER_PREFIX = 'atus-code:llm-output-language:';
...
/**
 * Returns the path to the LLM output language rule file (~/.atus-code/output-language.md).
 */
...
function parseOutputLanguageFromContent(content: string): string | null {
  // Primary: machine-readable marker (e.g., <!-- atus-code:llm-output-language: 中文 -->)
