 ...
 * CLI commands (like `atus extensions list`) where the output IS the user-facing
 * result, not debug logging.
 *
 * For debug/diagnostic logging, use `createDebugLogger()` from @atus-code/atus-code-core.
 */
