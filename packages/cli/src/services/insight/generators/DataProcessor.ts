...
function normalizeSessionFacet(
  ...
  const normalizedFacet: SessionFacets = {
    ...
    Atus_helpfulness: normalizeInsightEnum(
      rawFacet['Atus_helpfulness'],
      ATUS_HELPFULNESS_LEVELS,
      'moderately_helpful',
    ),
...
export class DataProcessor {
  ...
  private async generateQualitativeInsights(
    ...
    const schemaImprovements = {
      ...
      required: ['Atus_md_additions', 'features_to_try', 'usage_patterns'],
    };
