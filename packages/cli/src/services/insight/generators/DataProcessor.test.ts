...
import type { Config, ChatRecord } from '@atus-code/atus-code-core';
import type {
  InsightData,
  SessionFacets,
...
import { read as readJsonlFile } from '@atus-code/atus-code-core';
    ...
    it('should aggregate satisfaction counts', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          Atus_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          Atus_helpfulness: 'slightly_helpful',
