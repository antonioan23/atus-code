...
import { Config } from '@atus-code/atus-code-core';
...
vi.mock('@atus-code/atus-code-core', async () => {
  const actual = await vi.importActual('@atus-code/atus-code-core');
  return {
    ...actual,
...
describe('Configuration Integration Tests', () => {
  ...
  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(tmpdir(), 'atus-code-test-'));
