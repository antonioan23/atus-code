...
describe('validateAuthMethod', () => {
  ...
  it('should return an error for ATUS_OAUTH (free tier discontinued)', () => {
    const result = validateAuthMethod(AuthType.ATUS_OAUTH);
  ...
  it('should use config.getModelsConfig().getModel() when Config is provided', () => {
    ...
    } as unknown as import('@atus-code/atus-code-core').Config;
