 ...
 * vs global ~/.atus-code/QWEN.md), `mode` is the requested write mode, and
...
/** Provider id. Open string union for forward-compatible providers; `atus-oauth`
 *  is the only value v1 currently emits. */
export type DaemonAuthDeviceFlowProviderId = 'atus-oauth' | (string & {});
...
function isMcpBudgetWarningData(
  ...
  // in `atus-serve-protocol.md`. Pinning the literal in the SDK
