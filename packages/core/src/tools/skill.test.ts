...
describe('SkillTool', () => {
  ...
  const mockSkills: SkillConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.atus-code/skills/code-review/SKILL.md',
    ...
    },
    {
      ...
      level: 'user',
      filePath: '/home/user/.atus-code/skills/testing/SKILL.md',
      ...
      vi.mocked(mockSkillManager.listSkills).mockResolvedValue([
        {
          ...
          level: 'project',
          filePath: '/project/.atus-code/skills/xss-skill/SKILL.md',
          body: 'Body text.',
        },
      ]);
  ...
  describe('validateToolParams', () => {
    ...
    it('returns a path-activation error for a registered but not-yet-activated conditional skill', async () => {
      const conditionalSkill: SkillConfig = {
        ...
        level: 'project',
        filePath: '/test/project/.atus-code/skills/tsx-helper/SKILL.md',
        body: 'Body.',
        paths: ['src/**/*.tsx'],
      };
      vi.mocked(mockSkillManager.listSkills).mockResolvedValue([
      ...
      vi.mocked(mockSkillManager.listSkills).mockResolvedValue([
        {
          ...
          level: 'project',
          filePath: '/p/.atus-code/skills/mytool/SKILL.md',
          body: 'skill body',
        },
      ]);
      vi.mocked(config.getDisabledSkillNames).mockReturnValue(
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.atus-code/skills/new-skill/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.atus-code/skills/test-skill/SKILL.md',
          body: 'Test content.',
        },
      ];
  ...
  describe('SkillToolInvocation', () => {
    ...
    it('should execute skill load successfully', async () => {
      ...
      expect(llmText).toContain(
        'Base directory for this skill: /project/.atus-code/skills/code-review',
      );
  ...
  describe('modelInvocableCommands integration', () => {
    ...
    it('does not let a disable-model-invocation skill block an unrelated command of the same name', async () => {
      ...
      const hiddenSkill: SkillConfig = {
        ...
        level: 'project',
        filePath: '/test/project/.atus-code/skills/mcp-prompt-a/SKILL.md',
        body: 'Body.',
  ...
  describe('modelOverride propagation', () => {
    it.each(['atus-max', 'fast', 'openai:atus-max'])(
