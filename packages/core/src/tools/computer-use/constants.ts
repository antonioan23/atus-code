 ...
 *
 * This is the atuscode fork (`@atus-code/open-computer-use`), not upstream
 ...
 * https://github.com/atuscode/open-computer-use
 *
...
/**
 * The exact `@atus-code/open-computer-use` version this release of
 * atus-code is pinned to. Hardcoded `schemas.ts` is generated against
 ...
 * `ATUS_COMPUTER_USE_PACKAGE` env var at call time so tests / power
