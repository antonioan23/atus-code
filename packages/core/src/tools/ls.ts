...
export interface LSToolParams {
  ...
  /**
   * Whether to respect .gitignore and .atusignore patterns (optional, defaults to true)
   */
...
class LSToolInvocation extends BaseToolInvocation<LSToolParams, ToolResult> {
  ...
  async execute(_signal: AbortSignal): Promise<ToolResult> {
    try {
      ...
      const { filteredPaths, gitIgnoredCount, atusIgnoredCount } =
        fileDiscovery.filterFilesWithReport(relativePaths, {
          ...
          respectAtusIgnore:
            ...
            this.config.getFileFilteringOptions().respectAtusIgnore ??
      ...
      if (atusIgnoredCount > 0) {
        ignoredMessages.push(`${atusIgnoredCount} atus-ignored`);
      }
    ...
    super(
      ...
      Kind.Search,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              'Optional: Whether to respect ignore patterns from .gitignore or .atusignore',
            type: 'object',
            properties: {
              respect_git_ignore: {
                description:
              ...
              respect_qwen_ignore: {
                description:
                  'Optional: Whether to respect .atusignore patterns when listing files. Defaults to true.',
                type: 'boolean',
              },
            },
          },
