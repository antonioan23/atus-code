...
> {
  ...
  async execute(_signal: AbortSignal): Promise<ToolResult> {
    ...
    // Otherwise launching `atus` from a subdirectory of a monorepo would
    // make exit_worktree look at `<subdir>/.atus-code/worktrees/<slug>`,
    ...
    //    `.atus-code/worktrees/` and call `exit_worktree` with a name
