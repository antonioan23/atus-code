...
export enum HookEventName {
  ...
  // TodoCreated - When a new todo item is added to the list (atus code specific)
  TodoCreated = 'TodoCreated',
  // TodoCompleted - When a todo item's status changes to 'completed' (atus code specific)
