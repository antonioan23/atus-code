 ...
 * - 'project': Stored in `.atus-code/skills/` within the project directory
 * - 'user': Stored in `~/.atus-code/skills/` in the user's home directory
 * - 'extension': Provided by an installed extension
 * - 'bundled': Built-in skills shipped with atus-code
 */
...
export interface SkillConfig {
   ...
   * `fast`, bare model ID (e.g., `atus-coder-plus`),
   ...
   * Used to set ATUS_SKILL_ROOT environment variable for skill hooks.
   */
  skillRoot?: string;
