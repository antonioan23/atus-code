 ...
 */
export const ATUS_OAUTH_MODELS: ModelConfig[] = [
  {
    id: 'coder-model',
    name: 'coder-model',
    description:
...
/**
 * Derive allowed models from ATUS_OAUTH_MODELS for authorization.
 * This ensures single source of truth (SSOT).
 */
export const ATUS_OAUTH_ALLOWED_MODELS = ATUS_OAUTH_MODELS.map(
  (model) => model.id,
) as readonly string[];
