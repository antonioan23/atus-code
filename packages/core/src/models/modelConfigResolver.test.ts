...
describe('modelConfigResolver', () => {
  describe('resolveModelConfig', () => {
    describe('OpenAI auth type', () => {
      ...
      it('reads ATUS_MODEL as fallback for OPENAI_MODEL', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {},
          env: {
            ATUS_MODEL: 'atus-model',
            OPENAI_API_KEY: 'key',
          },
        });

        expect(result.config.model).toBe('atus-model');
        expect(result.sources['model'].envKey).toBe('ATUS_MODEL');
      });
    });
    ...
    describe('Qwen OAuth auth type', () => {
      it('uses default model for Qwen OAuth', () => {
        ...
        expect(result.config.apiKey).toBe('ATUS_OAUTH_DYNAMIC_TOKEN');
      ...
      it('ATUS_CODE_API_TIMEOUT_MS applies in Qwen OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
          env: {
            ATUS_CODE_API_TIMEOUT_MS: '45000',
          },
        });
        ...
        expect(result.sources['timeout'].envKey).toBe(
          'ATUS_CODE_API_TIMEOUT_MS',
        );
        expect(result.config.model).toBe(DEFAULT_QWEN_MODEL);
      });

      it('modelProvider timeout takes precedence over ATUS_CODE_API_TIMEOUT_MS in OAuth', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
      ...
      it('invalid ATUS_CODE_API_TIMEOUT_MS ignored in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
          env: {
            ATUS_CODE_API_TIMEOUT_MS: 'not-a-number',
          },
        });
      ...
      it('negative ATUS_CODE_API_TIMEOUT_MS ignored in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
          env: {
            ATUS_CODE_API_TIMEOUT_MS: '-100',
          },
        });
      ...
      it('zero ATUS_CODE_API_TIMEOUT_MS ignored in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
          env: {
            ATUS_CODE_API_TIMEOUT_MS: '0',
          },
        });
      ...
      it('ATUS_CODE_API_TIMEOUT_MS works with float value in OAuth', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
          env: {
            ATUS_CODE_API_TIMEOUT_MS: '12345.67',
          },
        });
      ...
      it('ATUS_CODE_API_TIMEOUT_MS works with proxy in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.ATUS_OAUTH,
          cli: {},
          settings: {},
          env: {
            ATUS_CODE_API_TIMEOUT_MS: '60000',
          },
    ...
    describe('generation config resolution', () => {
      ...
      it('ATUS_CODE_API_TIMEOUT_MS env var overrides settings timeout', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
          ...
          env: {
            OPENAI_API_KEY: 'key',
            ATUS_CODE_API_TIMEOUT_MS: '900000',
          },
        });
      ...
      it('modelProvider timeout wins over ATUS_CODE_API_TIMEOUT_MS', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {},
      ...
      it('ATUS_CODE_API_TIMEOUT_MS applies when modelProvider has no timeout', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {},
      ...
      it('ignores invalid ATUS_CODE_API_TIMEOUT_MS values', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
          ...
          env: {
            OPENAI_API_KEY: 'key',
            ATUS_CODE_API_TIMEOUT_MS: 'invalid',
          },
        });
      ...
      it('ignores negative or zero ATUS_CODE_API_TIMEOUT_MS values', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
      ...
      it('ATUS_CODE_API_TIMEOUT_MS works for Anthropic auth type', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_ANTHROPIC,
          cli: {},
          settings: {},
          env: {
            ...
            ATUS_CODE_API_TIMEOUT_MS: '600000',
          },
        });
      ...
      it('handles extremely large timeout values safely', () => {
        const result = resolveModelConfig({
          ...
          env: {
            OPENAI_API_KEY: 'key',
            ATUS_CODE_API_TIMEOUT_MS: '999999999',
          },
        });
      ...
      it('handles whitespace-padded env values', () => {
        const result = resolveModelConfig({
          ...
          env: {
            OPENAI_API_KEY: 'key',
            ATUS_CODE_API_TIMEOUT_MS: ' 300000 ',
          },
        });
      ...
      it('ignores negative ATUS_CODE_API_TIMEOUT_MS values', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
  ...
  describe('validateModelConfig', () => {
    ...
    it('always passes for Qwen OAuth', () => {
      const result = validateModelConfig({
        ...
        apiKey: 'ATUS_OAUTH_DYNAMIC_TOKEN',
      });
  ...
  describe('[Regression] timeout env override refactor', () => {
    it('[Regression] OAuth path must apply ATUS_CODE_API_TIMEOUT_MS (was broken before fix #3629)', () => {
      ...
      expect(result.sources['timeout']).toBeDefined();
      expect(result.sources['timeout'].kind).toBe('env');
      expect(result.sources['timeout'].envKey).toBe('ATUS_CODE_API_TIMEOUT_MS');
      expect(result.config.model).toBe(DEFAULT_QWEN_MODEL);
    });

    it('[Regression] non-OAuth path must apply ATUS_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        settings: { apiKey: 'key' },
  ...
  describe('[Additional] timeout env override edge cases', () => {
    it('handles scientific notation in ATUS_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        settings: { apiKey: 'key' },
        env: {
          OPENAI_API_KEY: 'key',
          ATUS_CODE_API_TIMEOUT_MS: '1.5e5',
        },
      });
    ...
    it('handles hex values in ATUS_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        ...
        env: {
          OPENAI_API_KEY: 'key',
          ATUS_CODE_API_TIMEOUT_MS: '0x2BF20', // 180000 in hex
        },
      });
    ...
    it('ignores empty string ATUS_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        settings: { apiKey: 'key', generationConfig: { timeout: 30000 } },
    ...
    it('applies env override for every supported auth type', () => {
      ...
      for (const { type, env } of authTypes) {
        const result = resolveModelConfig({
          ...
          env: { ...env, ATUS_CODE_API_TIMEOUT_MS: '99999' },
        });
