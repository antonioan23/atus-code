  ...
  implements OpenAICompatibleProvider
{
  ...
  buildHeaders(): Record<string, string | undefined> {
    ...
    const userAgent = `AtusCode/${version} (${process.platform}; ${process.arch})`;
   ...
   *    - Check ATUS_CODE_MAX_OUTPUT_TOKENS env var first
   ...
   * - User not set, env ATUS_CODE_MAX_OUTPUT_TOKENS=16000 -> uses 16K
   *
