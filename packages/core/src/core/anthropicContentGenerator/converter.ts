...
export interface ConvertGeminiRequestToAnthropicOptions {
   ...
   * stray thinking blocks. https://github.com/atuscode/atus-code/issues/3786
   */
...
export class AnthropicContentConverter {
  ...
  async convertGeminiToolsToAnthropic(
    ...
    // `convertGeminiRequestToAnthropic` so a atus-oauth-style hot flip of
    ...
    // hot-mutated — non-atus-oauth providers recreate the generator on
   ...
   * already-satisfying. https://github.com/atuscode/atus-code/issues/3786
   */
