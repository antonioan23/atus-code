...
describe('MCPOAuthProvider', () => {
  ...
  describe('Authorization URL building', () => {
    ...
    // Regression test for https://github.com/atuscode/atus-code/issues/1749
    // Scenario: user runs `atus mcp add --transport http yuque https://mcp.alibaba-inc.com/yuque/mcp`
