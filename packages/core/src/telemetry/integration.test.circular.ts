...
import type { RumEvent } from './atus-logger/event-types.js';
...
describe('Circular Reference Integration Test', () => {
  ...
  it('should handle HttpsProxyAgent-like circular references in atus logging', () => {
    ...
    // Test that AtusLogger can handle this
