...
export class ToolCallEvent implements BaseTelemetryEvent {
  ...
  constructor(call: CompletedToolCall) {
    ...
    // exports, AtusLogger, ui-telemetry stream, the chat-recording UI
...
export class ApiRetryEvent implements BaseTelemetryEvent {
   ...
   * own duration — that lives on the corresponding `atus-code.llm_request`
...
export class PromptSuggestionEvent implements BaseTelemetryEvent {
  'event.name': 'atus-code.prompt_suggestion';
  'event.timestamp': string;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'atus-code.prompt_suggestion';
    this['event.timestamp'] = new Date().toISOString();
...
export class SpeculationEvent implements BaseTelemetryEvent {
  'event.name': 'atus-code.speculation';
  'event.timestamp': string;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'atus-code.speculation';
    this['event.timestamp'] = new Date().toISOString();
    this.outcome = params.outcome;
...
export class MemoryExtractEvent implements BaseTelemetryEvent {
  'event.name': 'atus-code.memory.extract';
  'event.timestamp': string;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'atus-code.memory.extract';
    this['event.timestamp'] = new Date().toISOString();
...
export class MemoryDreamEvent implements BaseTelemetryEvent {
  'event.name': 'atus-code.memory.dream';
  'event.timestamp': string;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'atus-code.memory.dream';
    this['event.timestamp'] = new Date().toISOString();
    this.trigger = params.trigger;
    this.status = params.status;
...
export class MemoryRecallEvent implements BaseTelemetryEvent {
  'event.name': 'atus-code.memory.recall';
  'event.timestamp': string;
  query_length: number;
  docs_scanned: number;
  ...
  constructor(params: {
    ...
    this['event.name'] = 'atus-code.memory.recall';
    this['event.timestamp'] = new Date().toISOString();
