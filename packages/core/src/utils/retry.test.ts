...
describe('isUnattendedMode', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['ATUS_CODE_UNATTENDED_RETRY'];
  });
  ...
  it('should return true when ATUS_CODE_UNATTENDED_RETRY=1', () => {
    process.env['ATUS_CODE_UNATTENDED_RETRY'] = '1';
    expect(isUnattendedMode()).toBe(true);
  });

  it('should return true when ATUS_CODE_UNATTENDED_RETRY=true', () => {
    process.env['ATUS_CODE_UNATTENDED_RETRY'] = 'true';
    expect(isUnattendedMode()).toBe(true);
  });
  ...
  it('should return false for non-matching values', () => {
    process.env['ATUS_CODE_UNATTENDED_RETRY'] = '0';
    expect(isUnattendedMode()).toBe(false);
    process.env['ATUS_CODE_UNATTENDED_RETRY'] = 'false';
    expect(isUnattendedMode()).toBe(false);
    process.env['ATUS_CODE_UNATTENDED_RETRY'] = '';
    expect(isUnattendedMode()).toBe(false);
  });
  ...
  it('should use strict matching consistent with parseBooleanEnvFlag', () => {
    ...
    process.env['ATUS_CODE_UNATTENDED_RETRY'] = 'yes';
    expect(isUnattendedMode()).toBe(false);
  });
});
