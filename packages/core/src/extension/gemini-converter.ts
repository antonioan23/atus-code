...
/**
 * Converter for Gemini extensions to atus code format.
 */
...
/**
 * Converts a Gemini extension config to atus code format.
...
/**
 * Converts a complete Gemini extension package to atus code format.
...
export async function convertGeminiExtensionPackage(
  ...
  try {
    ...
    // Step 3: Create atus-extension.json with converted config
