...
describe('ChatCompressionService', () => {
  ...
  describe('screenshot-overflow trigger', () => {
    ...
    it('reads threshold + enable flag from ATUS_COMPACT_* env over settings', async () => {
      ...
      process.env['ATUS_COMPACT_SCREENSHOT_TRIGGER'] = 'true';
      process.env['ATUS_COMPACT_SCREENSHOT_THRESHOLD'] = '4';
      setWindow128k();
      const generateText = mockSummarySideQuery();
