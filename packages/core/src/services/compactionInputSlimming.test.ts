...
const COMPACTION_ENV_KEYS = [
  'ATUS_IMAGE_TOKEN_ESTIMATE',
  'ATUS_COMPACT_MAX_RECENT_FILES',
  'ATUS_COMPACT_MAX_RECENT_IMAGES',
  'ATUS_COMPACT_SCREENSHOT_TRIGGER',
  'ATUS_COMPACT_SCREENSHOT_THRESHOLD',
];
...
describe('compactionInputSlimming', () => {
  ...
  describe('resolveSlimmingConfig', () => {
    ...
    it('env overrides settings', () => {
      process.env['ATUS_IMAGE_TOKEN_ESTIMATE'] = '3000';
    ...
    it('falls through invalid env to settings, then defaults', () => {
      process.env['ATUS_IMAGE_TOKEN_ESTIMATE'] = 'not-a-number';
    ...
    it('rejects below-minimum values', () => {
      process.env['ATUS_IMAGE_TOKEN_ESTIMATE'] = '0';
      const cfg = resolveSlimmingConfig(undefined);
  ...
  describe('resolveCompactionTuning', () => {
    ...
    it('env overrides settings for every knob', () => {
      process.env['ATUS_COMPACT_MAX_RECENT_FILES'] = '7';
      process.env['ATUS_COMPACT_MAX_RECENT_IMAGES'] = '9';
      process.env['ATUS_COMPACT_SCREENSHOT_TRIGGER'] = '0';
      process.env['ATUS_COMPACT_SCREENSHOT_THRESHOLD'] = '99';
      const t = resolveCompactionTuning({
    ...
    it('parses the boolean env both ways and ignores typos', () => {
      process.env['ATUS_COMPACT_SCREENSHOT_TRIGGER'] = 'false';
      expect(resolveCompactionTuning(undefined).enableScreenshotTrigger).toBe(
        false,
      );
      process.env['ATUS_COMPACT_SCREENSHOT_TRIGGER'] = '1';
      expect(resolveCompactionTuning(undefined).enableScreenshotTrigger).toBe(
        true,
      );
      // Unrecognized env string falls through to the settings value.
      process.env['ATUS_COMPACT_SCREENSHOT_TRIGGER'] = 'yes-please';
      expect(
    ...
    it('falls through invalid numeric env to settings, then defaults', () => {
      process.env['ATUS_COMPACT_SCREENSHOT_THRESHOLD'] = 'not-a-number';
      expect(
      ...
      process.env['ATUS_COMPACT_SCREENSHOT_THRESHOLD'] = '0';
      expect(
