...
export interface WorktreeSession {
   ...
   * always lives under `<repoTopLevel>/.atus-code/worktrees/`. When the
...
export async function restoreWorktreeContext(
  ...
  // `<originalCwd>/.atus-code/worktrees/`. Schema validation (readWorktreeSession)
  ...
  const expectedParent = path.join(session.originalCwd, '.atus-code', 'worktrees');
