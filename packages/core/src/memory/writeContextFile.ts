...
export interface WriteContextFileResult {
   ...
   * content). Callers like the `atus serve` POST route use this to
 ...
 * `~/.atus-code/` directory. Used by the `atus serve` daemon's
 ...
 * `~/.atus-code/QWEN.md` may have been edited externally). 16 MB sits
