...
A shared React component library for Atus Code applications, providing cross-platform UI components with consistent styling and behavior.
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@atus-code/webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@atus-code/webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
    ...
    <script type="text/babel">
      // Access components from the global AtusCodeWebUI object
      const { ChatViewer } = AtusCodeWebUI;
...
```tsx
import { Button, Input, Tooltip } from '@atus-code/webui';
import { PlatformProvider } from '@atus-code/webui/context';
...
```tsx
import { Button } from '@atus-code/webui';
...
```tsx
import { Input } from '@atus-code/webui';
...
```tsx
import { Tooltip } from '@atus-code/webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@atus-code/webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@atus-code/webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@atus-code/webui/tailwind.preset.cjs')],
  // your customizations
};
```
