package com.alibaba.atus-code.code.cli.example;

import com.alibaba.fastjson2.JSON;
import com.alibaba.atus-code.code.cli.AtusCodeCli;
...
import com.alibaba.atus-code.code.cli.protocol.data.behavior.Behavior.Operation;
...
import com.alibaba.atus-code.code.cli.session.event.consumers.AssistantContentSimpleConsumers;
import com.alibaba.atus-code.code.cli.session.event.consumers.SessionEventSimpleConsumers;
...
import com.alibaba.atus-code.code.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void main(String[] args) {
        Session session = AtusCodeCli.newSession();
        try {
