...
import com.alibaba.atus-code.code.cli.session.event.consumers.AssistantContentConsumers;
...
import com.alibaba.atus-code.code.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the Atus Code CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class AtusCodeCli {
    private static final Logger log = LoggerFactory.getLogger(AtusCodeCli.class);

    /**
     * Sends a simple query to the Atus Code CLI and returns a list of responses.
     *
