package com.alibaba.atus-code.code.cli.protocol.message;
...
public class SDKSystemMessage extends MessageBase {
     ...
     * Atus Code version.
     */
    @JSONField(name = "atus_code_version")
    private String atusCodeVersion;
    /**
     * Output style.
     */
    ...
    /**
     * Gets the Atus Code version.
     *
     * @return The Atus Code version
     */
    public String getAtusCodeVersion() {
        return atusCodeVersion;
    }

    /**
     * Sets the Atus Code version.
     *
     * @param atusCodeVersion The Atus Code version
     */
    public void setAtusCodeVersion(String atusCodeVersion) {
        this.atusCodeVersion = atusCodeVersion;
    }
