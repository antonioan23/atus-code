...
This release includes updates to the atus code Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
```gradle
implementation 'com.alibaba:atuscode-sdk:0.0.1-alpha'
```
...
3. **Extended API Coverage**: More comprehensive coverage of atus code CLI features
...
- Issue Tracker: https://github.com/atuscode/atus-code/issues
