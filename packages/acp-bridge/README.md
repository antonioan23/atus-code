# `@atus-code/acp-bridge`

Shared ACP bridge primitives consumed by `atus serve`, channels, IDE, TUI,
...
The package exposes both a barrel root (`@atus-code/acp-bridge`) and
