...
const publicCliExportPlugin = {
  ...
  setup(build) {
    build.onResolve({ filter: /^@atus-code\/atus-code\/export$/ }, () => ({
...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    // @atus-code/atus-code-core is a peer dependency of @atus-code/webui.
    // Since @atus-code/webui marks it as external in its own Vite build, the
    ...
    // '@atus-code/atus-code-core/src/core/tokenLimits.js') are also excluded;
    ...
    external: ['@atus-code/atus-code-core', '@atus-code/atus-code-core/*'],
    logLevel: 'silent',
