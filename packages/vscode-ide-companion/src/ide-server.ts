...
const IDE_SERVER_PORT_ENV_VAR = 'ATUS_CODE_IDE_SERVER_PORT';
const IDE_WORKSPACE_PATH_ENV_VAR = 'ATUS_CODE_IDE_WORKSPACE_PATH';
const IDE_DIR = 'ide';
...
const createMcpServer = (diffManager: DiffManager) => {
  const server = new McpServer(
    {
      name: 'atus-code-companion-mcp-server',
      version: '1.0.0',
    },
