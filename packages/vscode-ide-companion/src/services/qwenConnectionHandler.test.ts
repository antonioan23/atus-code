...
import { AtusConnectionHandler } from './atusConnectionHandler.js';
import type { AcpConnection } from './acpConnection.js';

describe('AtusConnectionHandler', () => {
  let handler: AtusConnectionHandler;
  ...
  beforeEach(async () => {
    ...
    handler = new AtusConnectionHandler();
    mockConnection = {
  ...
  describe('connect retry logic', () => {
    ...
    beforeEach(() => {
      ...
      // (see atusConnectionHandler.ts), which is currently unreachable
