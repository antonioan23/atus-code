 ...
 */
export class AtusSessionUpdateHandler {
  private callbacks: AtusAgentCallbacks;

  constructor(callbacks: AtusAgentCallbacks) {
   ...
   */
  updateCallbacks(callbacks: AtusAgentCallbacks): void {
    this.callbacks = callbacks;
  }
  ...
  handleSessionUpdate(data: SessionNotification): void {
    ...
    switch (sessionUpdate) {
      ...
      default:
        console.log('[AtusAgentManager] Unhandled session update type');
        break;
    }
  }
