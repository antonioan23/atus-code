 ...
 * `atus-code:supportsSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'atus-code.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'atus-code.chatView.secondary';
