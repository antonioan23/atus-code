...
export const runAtusCodeCommand = 'atus-code.runAtusCode';
export const showDiffCommand = 'atusCode.showDiff';
export const openChatCommand = 'atus-code.openChat';
export const openNewChatTabCommand = 'atusCode.openNewChatTab';
export const authCommand = 'atus-code.auth';
export const focusChatCommand = 'atus-code.focusChat';
export const newConversationCommand = 'atus-code.newConversation';
export const showLogsCommand = 'atus-code.showLogs';

/**
 * Register all atus code chat-related commands.
 *
    ...
    vscode.commands.registerCommand(showLogsCommand, async () => {
      if (outputChannel) {
        ...
        vscode.window.showWarningMessage(
          'atus code Companion log channel is not available.',
        );
      }
    }),
  );
