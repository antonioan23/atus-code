 ...
 * All UI components are now imported from @atus-code/webui
 */

import { shouldShowToolCall, getToolCallComponent } from '@atus-code/webui';
import type { FC } from 'react';
import type { BaseToolCallProps } from '@atus-code/webui';
...
export type { BaseToolCallProps, ToolCallData } from '@atus-code/webui';
