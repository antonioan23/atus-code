...
import type { PermissionOption, PermissionToolCall } from '@atus-code/webui';
...
function findMessageIndex(
  ...
  // .atus-code-message class (e.g. InterruptedMessage does not).
  ...
  useEffect(() => {
    const clearEditingOnRestoreOrFailure = (event: MessageEvent) => {
      ...
      if (
        ...
        message?.type === 'atusSessionSwitched' ||
